...
public interface RequirementService {
	...
	List<Requirement> findAllByCondition(BasicDBObject andQuery, MongoSortVO sort);
	 ...
	 * @return
	 */
	Map<String, Integer> findTopCustomers(MongoSortVO sort, ObjectId vendorId);
	 ...
	 * @return
	 */
	Map<String, Integer> findRequirementsByJobLocation(Map<String, Object> condition, MongoSortVO sort) throws RAException;
}
